...
public class Pages {
    public static final String ADMIN_ARTIFACTS = "admin-artifacts";
    public static final String ADMIN_EDIT_ARTIFACT = "admin-edit-artifact";
    public static final String ADMIN_ADD_ARTIFACT = "admin-add-ARTIFACT";
