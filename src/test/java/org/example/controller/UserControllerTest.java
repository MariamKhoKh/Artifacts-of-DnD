...
public class UserControllerTest {
    ...
    public void editUserInfo() throws Exception {
        mockMvc.perform(post(PathConstants.USER + "/info/edit")
                        .param("firstName", TestConstants.USER_FIRST_NAME)
                        .param("lastName", TestConstants.USER_LAST_NAME)
                        .param("city", TestConstants.USER_CITY)
                        .param("address", TestConstants.USER_ADDRESS)
                        .param("phoneNumber", TestConstants.USER_PHONE_NUMBER)
                        .param("postIndex", TestConstants.USER_POST_INDEX))
    ...
    public void editUserInfo_ReturnInputErrors() throws Exception {
        mockMvc.perform(post(PathConstants.USER + "/info/edit")
                        .param("email", TestConstants.USER_EMAIL)
                        .param("firstName", "")
                        .param("lastName", ""))
                .andExpect(status().isOk())
                .andExpect(view().name(Pages.USER_INFO_EDIT))
